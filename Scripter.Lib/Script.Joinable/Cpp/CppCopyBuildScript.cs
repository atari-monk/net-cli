...
public class CppCopyBuildScript
    : IScript
{
    ...
    public CppCopyBuildScript(IScriptParam scriptParam)
    {
    ...
    public string[] GetScript()
    {
        ...
        return new string[]
        {
            ...
            , "}"
            , $"Copy-Item -Path \"{appProjPath}\\bin\\Release\\publish\\*\" "
